...
class DiagnosticReportDataLoader(epicClient: EpicClient) {
    private val logger = KotlinLogging.logger { }
    private val diagnosticReportService = EpicDiagnosticReportService(epicClient)
    private val binaryService = EpicBinaryService(epicClient)
...
class EpicBinaryService(private val epicClient: EpicClient) {
